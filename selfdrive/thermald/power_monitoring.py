...
MAX_TIME_OFFROAD_S = 10
MIN_ON_TIME_S = 10
DELAY_SHUTDOWN_TIME_S = 10 # Wait at least DELAY_SHUTDOWN_TIME_S seconds after offroad_time to shutdown.
VOLTAGE_SHUTDOWN_MIN_OFFROAD_TIME_S = 10
